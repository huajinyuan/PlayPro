...
public class WeekPresenter implements IRecommented {
    StarDelegate delegate;
    IFollowItemListener listener;
    UserInfo info;
    ACache aCache;

    public WeekPresenter(StarDelegate delegate, IFollowItemListener listener) {
...
//                            ToastUtil.showToast("操作成功",delegate.getActivity());
    ...
    private void getData() {
        ...
        GetRequest request = OkGo.get(Config.COMMON_WEEKTOP).params(params);
