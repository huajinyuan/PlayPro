    ...
    public void setStatus(int i) {
        ...
        switch (i) {
            case 0:
                ...
                mBtnTyrants.setTextColor(ContextCompat.getColor(this.getActivity(), R.color.colorwhite));
                break;
            case 1:
                mBtnStar.setBackgroundResource(R.drawable.shape_orange_indicator_r);
                mBtnStar.setTextColor(ContextCompat.getColor(this.getActivity(), R.color.colorwhite));
                break;
        }
    }
}
