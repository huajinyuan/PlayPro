package cn.gtgs.base.playpro.widget.MyRecycle.base;
...
public abstract class BaseLayout extends LinearLayout
    ...
    protected int contentViewColor = Color.parseColor("#00000000");
    ...
    private void init(final Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        duration = array.getInteger(R.styleable.NRecyclerView_duration, 50);
...
//                        setPullLoadEnable(false);
    ...
    private void handlePushNestStop() {
        F.e("--------------------------------------------isPullLoadEnable:" + isPullLoadEnable);
        if (standView == null) {
            if (isPullLoadEnable) {
                //load more.
                if (loaderView != null) {
