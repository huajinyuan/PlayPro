...
public class PeriscopeLayout extends RelativeLayout {
    ...
    private void init() {
        ...
        Drawable red = getResources().getDrawable(R.mipmap.loving_ico_pink);
        Drawable yellow = getResources().getDrawable(R.mipmap.loving_ico_yellow);
        Drawable blue = getResources().getDrawable(R.mipmap.loving_icopurple);
