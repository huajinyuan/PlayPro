...
import cn.gtgs.base.playpro.activity.home.fragment.presenter.WeekPresenter;
...
public class FragmentWeek extends FragmentPresenter<StarDelegate> implements IFollowItemListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void init() {
        super.init();
        presenter = new WeekPresenter(viewDelegate, this);
        presenter.initData();
